...
.controller('adminCtrl', ['$scope', '$timeout', function($scope, $timeout) {
  ...
  $scope.msgAccueil = false;
  $scope.msgPgs = false;
  $scope.matos = false;
  $scope.emprunts = true;
  $scope.UE = false;

  $scope.msgAccueilButton = "";
  $scope.msgPgsButton = "";
  $scope.matosButton = "";
  $scope.empruntsButton = "btn-primary";
  $scope.UEButton = "";

  function setButtonColor(msgAccueilButton, msgPgsButton, matosButton, empruntsButton, UEButton) {
    $scope.msgAccueilButton = msgAccueilButton;
    $scope.msgPgsButton = msgPgsButton;
    $scope.matosButton = matosButton;
    $scope.empruntsButton = empruntsButton;
    $scope.UEButton = UEButton;
  }

  function setVisibilityTab(msgAccueil, msgPgs, matos, emprunts, UE) {
    $scope.msgAccueil = msgAccueil;
    $scope.msgPgs = msgPgs;
    $scope.matos = matos;
  ...
  $scope.toMsgAccueil = function() {

    setButtonColor("btn-primary", "", "", "", "");
    setVisibilityTab(true, false, false, false, false);
  }

  $scope.toMsgPgs = function() {

    setButtonColor("", "btn-primary", "", "", "");
    setVisibilityTab(false, true, false, false, false);
  }

  $scope.toMatos = function() {

    setButtonColor("", "", "btn-primary", "", "");
    setVisibilityTab(false, false, true, false, false);
  }

  $scope.toEmprunts = function() {

    setButtonColor("", "", "", "btn-primary", "");
    setVisibilityTab(false, false, false, true, false);
  }

  $scope.toUE = function() {

    setButtonColor("", "", "", "", "btn-primary");
    setVisibilityTab(false, false, false, false, true);
  }
